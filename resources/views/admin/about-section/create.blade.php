                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="flex items-center gap-2">
                                ...
                                <span id="card-count-badge" class="px-2 py-0.5 text-[11px] font-bold bg-emerald-100 text-emerald-800 rounded-full">1 Card</span>
                            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200/80 shadow-xs p-6">
                <div class="flex items-center gap-3 pb-5 border-b border-gray-100 mb-5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Tentukan apakah section ini langsung aktif.</p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-[11px] text-slate-400 leading-relaxed">
                        <span class="font-semibold text-slate-600">Catatan:</span> Hanya satu About Section yang dapat aktif di landing page. Jika diaktifkan, section aktif sebelumnya akan otomatis diubah menjadi draft.
                    </p>
