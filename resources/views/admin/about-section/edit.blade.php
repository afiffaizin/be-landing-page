...
@section('title', 'Edit Konten - Tentang Kami')
...
@section('page_headline', 'Edit Konten Tentang Kami')
                ...
                <div class="bg-white rounded-2xl border border-gray-200/80 shadow-xs p-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <x-form.rich-editor name="description" :value="old('description', $aboutSection->description)" placeholder="Tulis latar belakang, visi, atau penjelasan rinci tentang program..." />
                            <p class="text-[11px] text-slate-400 mt-1.5">
                        ...
                        @forelse($aboutSection->cards as $idx => $card)
                            <div class="card-item rounded-xl border border-slate-200 bg-slate-50/40 overflow-hidden transition-all shadow-2xs"
                                ...
                                <div class="card-body p-4 space-y-4 bg-white">
                                    ...
                                    <!-- Icon Selection -->
                                    <x-form.icon-picker
                                        name="cards[{{ $idx }}][icon_name]"
                                        :value="old('cards.' . $idx . '.icon_name', $card->icon_name)"
                                        label="Icon Card (Opsional)"
                                        :with-upload="true"
                                        upload-name="cards[{{ $idx }}][icon_image]"
                                        :upload-value="$card->icon_image_url"
                    ...
                    <div class="pt-4 border-t border-gray-100 space-y-2 text-xs">
                        <div class="flex justify-between items-start text-slate-500">
                            ...
                            <div class="text-right">
                                <span class="text-slate-700 font-medium">{{ $aboutSection->updated_at->translatedFormat('d M Y, H:i') }} WIB</span>
                                <span class="text-[11px] text-slate-400 block">({{ $aboutSection->updated_at->diffForHumans() }})</span>
                            </div>
                        </div>
                    </div>
                </div>
