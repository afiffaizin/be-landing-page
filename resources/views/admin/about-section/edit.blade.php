                            ...
                            <div class="point-body p-4 space-y-3.5 bg-white">
                                ...
                                <div>
                                    ...
                                    <textarea name="points[{{ $idx }}][description]"
                                              ...
                                              class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600">{{ $point['description'] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
