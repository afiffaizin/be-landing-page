...
@section('header_actions')
    <a href="{{ route('admin.about-sections.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-xl shadow-xs transition-colors">
...
@section('page_subtitle', 'Kelola latar belakang program, visi misi singkat, serta poin-poin pilar keunggulan pengabdian.')
@section('status_badge')
    <span class="text-xs text-slate-500 font-medium">Total: {{ $aboutSections->total() }} Record</span>
@endsection
                    ...
                    @forelse($aboutSections as $section)
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="py-3.5 px-5 whitespace-nowrap">
                                ...
                                @endphp
                                <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-semibold bg-indigo-50 text-indigo-700 border border-indigo-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="py-16 text-center">
                                ...
                                <a href="{{ route('admin.about-sections.create') }}" class="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-xl transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                    </svg>
                                    <span>Buat About Section Baru</span>
