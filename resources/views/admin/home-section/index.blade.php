...
<div class="space-y-5">
    ...
    <div class="bg-white p-4 rounded-2xl border border-gray-200/80 shadow-xs">
        <form action="{{ route('admin.home-sections.index') }}" method="GET" class="flex flex-col sm:flex-row items-center gap-3 w-full">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto shrink-0">
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    @if(request('search') || request('status'))
                        <a href="{{ route('admin.home-sections.index') }}" class="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-rose-50 hover:bg-rose-100 text-rose-600 text-xs font-semibold rounded-xl transition-all" title="Reset Filter">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="py-3.5 px-5 whitespace-nowrap">
                                @if($section->button_one_text)
                                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-emerald-50 text-emerald-700 font-medium text-[11px] border border-emerald-200/80">
                            ...
                            <td class="py-3.5 px-5 whitespace-nowrap">
                                @if($section->button_two_text)
                                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-gray-100 text-slate-700 font-medium text-[11px] border border-gray-200">
