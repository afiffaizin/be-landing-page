                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               required
                               maxlength="255"
                               placeholder="Contoh: Afif Faizin"
                    ...
                    <div>
                        ...
                        <input type="email"
                               ...
                               required
                               maxlength="255"
                               placeholder="Contoh: admin@pengabdian.id"
                               class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 transition-all">
                    </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200/80 shadow-xs p-6">
                <div class="flex items-center gap-3 pb-5 border-b border-gray-100 mb-5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Pilih modul konten yang boleh diakses user ini. Super Admin otomatis mendapat semua akses.</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200/80 shadow-xs p-6">
                ...
                <div class="space-y-3 text-xs text-slate-600">
                    <div class="flex items-start gap-2">
                        <span class="w-5 h-5 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">1</span>
                        <p>Isi data lengkap: nama, email, dan password.</p>
                    </div>
                    <div class="flex items-start gap-2">
                        <span class="w-5 h-5 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">2</span>
                        <p>Pilih role: <strong>Super Admin</strong> (semua akses) atau <strong>Admin</strong> (akses terbatas).</p>
                    </div>
                    <div class="flex items-start gap-2">
                        <span class="w-5 h-5 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">3</span>
